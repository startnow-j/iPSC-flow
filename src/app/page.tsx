...
const PRODUCT_LINE_STATS: Record<string, {
  ...
  CELL_PRODUCT: {
    ...
    stats: [
      ...
      { key: 'COA_APPROVED', title: '已批准', icon: CheckCircle2, color: 'text-cyan-600 dark:text-cyan-400', dotColor: 'bg-cyan-400', },
  ...
  SERVICE: {
    ...
    stats: [
      ...
      { key: 'HANDOVER', title: '交接中', icon: Clock, color: 'text-amber-500 dark:text-amber-300', dotColor: 'bg-amber-300', },
